...
export default function Navbar() {
  return (
    <nav className="sticky top-0 z-50 backdrop-blur-md border-b-[0.5px] border-brand-border bg-[#131318]/80 text-brand-text-body">
      <div className="max-w-[1280px] mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <a
          ...
          className="border border-brand-accent text-brand-accent px-5 py-2 rounded-full font-medium hover:bg-brand-accent hover:text-brand-accent-dark transition-all"
        >
          Resume
        </a>
      </div>
